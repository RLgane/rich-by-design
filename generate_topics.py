...
EXAMPLE = {
    ...
    "segments": [
        {"text": "The wealthy don't budget to spend less. They budget to think.", "keywords": "city skyline night"},
        {"text": "And the next habit feels almost backwards.", "keywords": "person walking city street"},
        ...
        {"text": "Follow for the money mindset they never taught you.", "keywords": "city skyline sunrise"},
    ],
    "description": "Wealth is built quietly, one habit at a time. Follow for the money mindset they never taught you. \U0001F4B0",
...
def build_prompt(n, existing_titles):
    return (
        ...
        "- exactly 6 segments. Segment 1 = THE HOOK: the single most counter-intuitive idea, under 12 words. "
        "Never start with 'Did you know'.\n"
        "- segment 2 = short open-loop tease ('And the next one feels backwards.').\n"
        "- the SECOND-TO-LAST segment loops back to the opening hook (seamless rewatch).\n"
        "- the LAST segment text MUST be exactly: 'Follow for the money mindset they never taught you.'\n"
        "- write for a SPOKEN voiceover: short, calm, confident, simple words. No hype, no exclamation spam.\n"
        ...
        "- description: one engaging sentence ending with 'Follow for the money mindset they never taught you.'. "
...
def valid(t):
    ...
    for seg in t["segments"]:
        if "text" not in seg or "keywords" not in seg:
            return False
    t.setdefault("description", t["title"] + " Follow for the money mindset they never taught you.")
